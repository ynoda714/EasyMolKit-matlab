...
| **L3 Analytics** | 全ユーザー | 要統計 ML 等 | QSAR・クラスタリング・MS 解析・最適化など（A01〜A10、各 30〜60 分） | 🔜 v1.2.0 予定 |
...
### Layer 3 & 4: Analytics と Research

> 🔜 **未リリース。** モジュール詳細は公開時に掲載します。
>
> L3 Analytics（A01〜A10）は **v1.2.0** で予定。L4 Research（R01〜R10）は **v1.3.0** で予定。
